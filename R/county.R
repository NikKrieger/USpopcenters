...
#' 2020 decennial census are also included.
#'
#' Unlike \code{\link{county2000}}, \code{county2020} and
#' \code{\link{county2010}} do not contain data from American Samoa, Guam, the
#' Northern Mariana Islands, or the US Virgin Islands. Also unlike
#' \code{\link{county2000}}, \code{county2020} and \code{\link{county2010}}
#' contain the state name column \code{STNAME}.
#'
...
#'   \code{\link{tract2020}}; \code{\link{block_group2020}};
...
#'
#' Unlike \code{\link{county2000}}, \code{county2010} and
#' \code{\link{county2020}} do not contain data from American Samoa, Guam, the
#' Northern Mariana Islands, or the US Virgin Islands. Also unlike
#' \code{\link{county2000}}, \code{county2010} and \code{\link{county2020}}
#' contain the state name column \code{STNAME}.
#'
#' @format A \code{\link[tibble]{tibble}} with 3,221 rows and 7 variables:
#'
...
#'
#' Unlike \code{\link{county2020}} and \code{\link{county2010}},
#' \code{county2000} contains data from American Samoa, Guam, the Northern
#' Mariana Islands, and the US Virgin Islands. Also unlike
#' \code{\link{county2020}} and \code{\link{county2010}}, \code{county2000} does
#' not contain the \code{STNAME} (state name) column.
#'
